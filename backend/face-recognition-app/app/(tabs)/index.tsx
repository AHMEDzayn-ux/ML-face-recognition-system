...
const API_URL = "http://10.28.170.214:8000/mark_attendance";
...
export default function HomeScreen() {
  ...
  // Capture and send photo - FIRE AND FORGET!
  const capturePhoto = async () => {
    ...
    try {
      ...
      if (photo?.uri) {
        // 2. Add to queue immediately (non-blocking!)
        ...
        // 3. Haptic feedback - capture success!
        Vibration.vibrate(50);
        
        // 4. Camera is IMMEDIATELY ready for next person! ✅
